...
#[doc = "Field ` PWM_REPEAT_CAP_EDGE` reader - timer PWM repeat mode _timer capture edge mode"]
...
#[doc = "Field ` PWM_REPEAT_CAP_EDGE` writer - timer PWM repeat mode _timer capture edge mode"]
...
impl R {
    ...
    #[doc = "Bits 6:7 - timer PWM repeat mode _timer capture edge mode"]
    #[inline(always)]
