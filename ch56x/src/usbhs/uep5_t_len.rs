...
pub struct UEP5_T_LEN_R(crate::FieldReader<u16, u16>);
impl UEP5_T_LEN_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        UEP5_T_LEN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for UEP5_T_LEN_R {
...
pub struct UEP5_T_LEN_W<'a> {
    w: &'a mut W,
}
impl<'a> UEP5_T_LEN_W<'a> {
...
impl W {
    #[doc = "Bits 0:15 - endpoint 5 transmittal length"]
    #[inline(always)]
    pub fn uep5_t_len(&mut self) -> UEP5_T_LEN_W {
        UEP5_T_LEN_W { w: self }
    }
