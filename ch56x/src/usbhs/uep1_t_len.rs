...
pub struct UEP1_T_LEN_R(crate::FieldReader<u16, u16>);
impl UEP1_T_LEN_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        UEP1_T_LEN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for UEP1_T_LEN_R {
...
pub struct UEP1_T_LEN_W<'a> {
    w: &'a mut W,
}
impl<'a> UEP1_T_LEN_W<'a> {
...
impl W {
    #[doc = "Bits 0:15 - endpoint 1 transmittal length"]
    #[inline(always)]
    pub fn uep1_t_len(&mut self) -> UEP1_T_LEN_W {
        UEP1_T_LEN_W { w: self }
    }
