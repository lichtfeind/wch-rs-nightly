...
pub struct UEP0_T_LEN_R(crate::FieldReader<u16, u16>);
impl UEP0_T_LEN_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        UEP0_T_LEN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for UEP0_T_LEN_R {
...
pub struct UEP0_T_LEN_W<'a> {
    w: &'a mut W,
}
impl<'a> UEP0_T_LEN_W<'a> {
