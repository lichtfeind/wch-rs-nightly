...
#[doc = "Field `DLAB_RB_LCR_GP_BIT` reader - UART reserved bit _UART general purpose bit"]
...
#[doc = "Field `DLAB_RB_LCR_GP_BIT` writer - UART reserved bit _UART general purpose bit"]
