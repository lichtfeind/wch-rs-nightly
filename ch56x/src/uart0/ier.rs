...
#[doc = "Field `MODEM_CHG` reader - UART0 interrupt enable for modem status change"]
pub struct MODEM_CHG_R(crate::FieldReader<bool, bool>);
impl MODEM_CHG_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        MODEM_CHG_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for MODEM_CHG_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
#[doc = "Field `MODEM_CHG` writer - UART0 interrupt enable for modem status change"]
pub struct MODEM_CHG_W<'a> {
    w: &'a mut W,
}
impl<'a> MODEM_CHG_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Field `DTR_EN` reader - UART0 DTR/TNOW output pin enable"]
pub struct DTR_EN_R(crate::FieldReader<bool, bool>);
impl DTR_EN_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        DTR_EN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DTR_EN_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
#[doc = "Field `DTR_EN` writer - UART0 DTR/TNOW output pin enable"]
pub struct DTR_EN_W<'a> {
    w: &'a mut W,
}
impl<'a> DTR_EN_W<'a> {
    #[doc = r"Sets the field bit"]
...
#[doc = "Field `RTS_EN` reader - UART0 RTS output pin enable"]
...
#[doc = "Field `RTS_EN` writer - UART0 RTS output pin enable"]
...
impl W {
    ...
    #[doc = "Bit 3 - UART0 interrupt enable for modem status change"]
    #[inline(always)]
    pub fn modem_chg(&mut self) -> MODEM_CHG_W {
        MODEM_CHG_W { w: self }
    }
    #[doc = "Bit 4 - UART0 DTR/TNOW output pin enable"]
    #[inline(always)]
    pub fn dtr_en(&mut self) -> DTR_EN_W {
        DTR_EN_W { w: self }
    }
    #[doc = "Bit 5 - UART0 RTS output pin enable"]
    #[inline(always)]
