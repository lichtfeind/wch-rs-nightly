...
#[doc = "Field `PWM1_DATA` reader - PWM1 data holding"]
pub struct PWM1_DATA_R(crate::FieldReader<u8, u8>);
impl PWM1_DATA_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        PWM1_DATA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PWM1_DATA_R {
...
#[doc = "Field `PWM1_DATA` writer - PWM1 data holding"]
pub struct PWM1_DATA_W<'a> {
    w: &'a mut W,
}
impl<'a> PWM1_DATA_W<'a> {
...
impl R {
    #[doc = "Bits 0:7 - PWM1 data holding"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:7 - PWM1 data holding"]
    #[inline(always)]
    pub fn pwm1_data(&mut self) -> PWM1_DATA_W {
        PWM1_DATA_W { w: self }
    }
...
#[doc = "`read()` method returns [pwm1_data::R](R) reader structure"]
impl crate::Readable for PWM1_DATA_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pwm1_data::W](W) writer structure"]
impl crate::Writable for PWM1_DATA_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PWM1_DATA to value 0"]
