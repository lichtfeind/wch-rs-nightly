...
pub struct RB_HSPI_RX_NUM_R(crate::FieldReader<u8, u8>);
impl RB_HSPI_RX_NUM_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        RB_HSPI_RX_NUM_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RB_HSPI_RX_NUM_R {
...
pub struct RB_HSPI_RX_NUM_W<'a> {
    w: &'a mut W,
}
impl<'a> RB_HSPI_RX_NUM_W<'a> {
...
pub struct RB_HSPI_RX_TOG_R(crate::FieldReader<bool, bool>);
impl RB_HSPI_RX_TOG_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        RB_HSPI_RX_TOG_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RB_HSPI_RX_TOG_R {
...
pub struct RB_HSPI_RX_TOG_W<'a> {
    w: &'a mut W,
}
impl<'a> RB_HSPI_RX_TOG_W<'a> {
...
impl W {
    #[doc = "Bits 0:3 - parallel if rx sequence num"]
    #[inline(always)]
    pub fn rb_hspi_rx_num(&mut self) -> RB_HSPI_RX_NUM_W {
        RB_HSPI_RX_NUM_W { w: self }
    }
    #[doc = "Bit 4 - parallel if rx addr toggle flag"]
    #[inline(always)]
    pub fn rb_hspi_rx_tog(&mut self) -> RB_HSPI_RX_TOG_W {
        RB_HSPI_RX_TOG_W { w: self }
    }
