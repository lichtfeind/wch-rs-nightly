#[doc = "Register `SPI0_CTRL_CFG` reader"]
...
#[doc = "Register `SPI0_CTRL_CFG` writer"]
...
#[doc = "`read()` method returns [spi0_ctrl_cfg::R](R) reader structure"]
impl crate::Readable for SPI0_CTRL_CFG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [spi0_ctrl_cfg::W](W) writer structure"]
impl crate::Writable for SPI0_CTRL_CFG_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SPI0_CTRL_CFG to value 0"]
