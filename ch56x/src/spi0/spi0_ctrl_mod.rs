#[doc = "Register `SPI0_CTRL_MOD` reader"]
...
#[doc = "Register `SPI0_CTRL_MOD` writer"]
...
#[doc = "Field `RB_SPI_MST_SCK_MOD_RB_SPI_SLV_CMD_MOD` reader - SPI master clock mode _SPI slave command mode"]
...
#[doc = "Field `RB_SPI_MST_SCK_MOD_RB_SPI_SLV_CMD_MOD` writer - SPI master clock mode _SPI slave command mode"]
...
impl R {
    ...
    #[doc = "Bit 3 - SPI master clock mode _SPI slave command mode"]
    #[inline(always)]
...
#[doc = "`read()` method returns [spi0_ctrl_mod::R](R) reader structure"]
impl crate::Readable for SPI0_CTRL_MOD_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [spi0_ctrl_mod::W](W) writer structure"]
impl crate::Writable for SPI0_CTRL_MOD_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SPI0_CTRL_MOD to value 0x02"]
