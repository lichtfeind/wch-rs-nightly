#[doc = "Register `SPI0_INTER_EN` reader"]
...
#[doc = "Register `SPI0_INTER_EN` writer"]
...
#[doc = "`read()` method returns [spi0_inter_en::R](R) reader structure"]
impl crate::Readable for SPI0_INTER_EN_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [spi0_inter_en::W](W) writer structure"]
impl crate::Writable for SPI0_INTER_EN_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SPI0_INTER_EN to value 0"]
