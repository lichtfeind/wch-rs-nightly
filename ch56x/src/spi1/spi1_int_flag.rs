#[doc = "Register `SPI1_INT_FLAG` reader"]
...
#[doc = "Register `SPI1_INT_FLAG` writer"]
...
#[doc = "`read()` method returns [spi1_int_flag::R](R) reader structure"]
impl crate::Readable for SPI1_INT_FLAG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [spi1_int_flag::W](W) writer structure"]
impl crate::Writable for SPI1_INT_FLAG_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SPI1_INT_FLAG to value 0"]
