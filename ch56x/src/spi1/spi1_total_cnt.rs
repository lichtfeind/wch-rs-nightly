#[doc = "Register `SPI1_TOTAL_CNT` reader"]
...
#[doc = "Register `SPI1_TOTAL_CNT` writer"]
...
#[doc = "Field `SPI1_TOTAL_CNT` reader - SPI total byte count, only low 12 bit"]
pub struct SPI1_TOTAL_CNT_R(crate::FieldReader<u16, u16>);
impl SPI1_TOTAL_CNT_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        SPI1_TOTAL_CNT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SPI1_TOTAL_CNT_R {
...
#[doc = "Field `SPI1_TOTAL_CNT` writer - SPI total byte count, only low 12 bit"]
pub struct SPI1_TOTAL_CNT_W<'a> {
    w: &'a mut W,
}
impl<'a> SPI1_TOTAL_CNT_W<'a> {
...
impl W {
    #[doc = "Bits 0:15 - SPI total byte count, only low 12 bit"]
    #[inline(always)]
    pub fn spi1_total_cnt(&mut self) -> SPI1_TOTAL_CNT_W {
        SPI1_TOTAL_CNT_W { w: self }
    }
...
#[doc = "`read()` method returns [spi1_total_cnt::R](R) reader structure"]
impl crate::Readable for SPI1_TOTAL_CNT_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [spi1_total_cnt::W](W) writer structure"]
impl crate::Writable for SPI1_TOTAL_CNT_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SPI1_TOTAL_CNT to value 0"]
