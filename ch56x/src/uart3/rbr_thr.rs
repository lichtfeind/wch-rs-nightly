...
#[doc = "Field `RBR_R8_UART3_THR` reader - UART receiver buffer, receiving byte _ UART transmitter holding, transmittal byte"]
pub struct RBR_R8_UART3_THR_R(crate::FieldReader<u8, u8>);
impl RBR_R8_UART3_THR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        RBR_R8_UART3_THR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RBR_R8_UART3_THR_R {
...
#[doc = "Field `RBR_R8_UART3_THR` writer - UART receiver buffer, receiving byte _ UART transmitter holding, transmittal byte"]
pub struct RBR_R8_UART3_THR_W<'a> {
    w: &'a mut W,
}
impl<'a> RBR_R8_UART3_THR_W<'a> {
...
impl R {
    #[doc = "Bits 0:7 - UART receiver buffer, receiving byte _ UART transmitter holding, transmittal byte"]
    #[inline(always)]
    pub fn rbr_r8_uart3_thr(&self) -> RBR_R8_UART3_THR_R {
        RBR_R8_UART3_THR_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:7 - UART receiver buffer, receiving byte _ UART transmitter holding, transmittal byte"]
    #[inline(always)]
    pub fn rbr_r8_uart3_thr(&mut self) -> RBR_R8_UART3_THR_W {
        RBR_R8_UART3_THR_W { w: self }
    }
