...
#[doc = "Register `USB_RX_LEN` writer"]
pub struct W(crate::W<USB_RX_LEN_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USB_RX_LEN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USB_RX_LEN_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USB_RX_LEN_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
#[doc = "`write(|w| ..)` method takes [usb_rx_len::W](W) writer structure"]
impl crate::Writable for USB_RX_LEN_SPEC {
    type Writer = W;
}
