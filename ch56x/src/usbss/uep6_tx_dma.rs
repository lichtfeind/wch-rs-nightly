...
pub struct R(crate::R<UEP6_TX_DMA_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UEP6_TX_DMA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UEP6_TX_DMA_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UEP6_TX_DMA_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UEP6_TX_DMA` writer"]
pub struct W(crate::W<UEP6_TX_DMA_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UEP6_TX_DMA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UEP6_TX_DMA_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UEP6_TX_DMA_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [uep6_tx_dma](index.html) module"]
