...
#[doc = "Field `DMA_ENABLE` reader - timer1/2 DMA enable"]
...
#[doc = "Field `DMA_ENABLE` writer - timer1/2 DMA enable"]
...
#[doc = "Field `DMA_LOOP` reader - timer1/2 DMA address loop enable"]
...
#[doc = "Field `DMA_LOOP` writer - timer1/2 DMA address loop enable"]
