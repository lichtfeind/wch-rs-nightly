...
#[doc = "`read()` method returns [pa_dir::R](R) reader structure"]
impl crate::Readable for PA_DIR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pa_dir::W](W) writer structure"]
impl crate::Writable for PA_DIR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PA_DIR to value 0"]
