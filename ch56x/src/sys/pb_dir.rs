...
#[doc = "Set GPIO direction for GPIO 24"]
pub type DIR24_A = DIR0_A;
#[doc = "Field `DIR24` reader - Set GPIO direction for GPIO 24"]
pub type DIR24_R = DIR0_R;
#[doc = "Field `DIR24` writer - Set GPIO direction for GPIO 24"]
...
impl R {
    ...
    #[doc = "Bit 24 - Set GPIO direction for GPIO 24"]
    #[inline(always)]
    pub fn dir24(&self) -> DIR24_R {
        DIR24_R::new(((self.bits >> 24) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Set GPIO direction for GPIO 0"]
...
#[doc = "`read()` method returns [pb_dir::R](R) reader structure"]
impl crate::Readable for PB_DIR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pb_dir::W](W) writer structure"]
impl crate::Writable for PB_DIR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PB_DIR to value 0"]
