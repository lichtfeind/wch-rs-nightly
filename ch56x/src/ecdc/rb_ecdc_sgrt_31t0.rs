...
pub struct RB_ECDC_SGRT_31T0_R(crate::FieldReader<u32, u32>);
impl RB_ECDC_SGRT_31T0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        RB_ECDC_SGRT_31T0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RB_ECDC_SGRT_31T0_R {
...
pub struct RB_ECDC_SGRT_31T0_W<'a> {
    w: &'a mut W,
}
impl<'a> RB_ECDC_SGRT_31T0_W<'a> {
...
impl W {
    #[doc = "Bits 0:31 - Single encryption and decryption result 0-31 register"]
    #[inline(always)]
    pub fn rb_ecdc_sgrt_31t0(&mut self) -> RB_ECDC_SGRT_31T0_W {
        RB_ECDC_SGRT_31T0_W { w: self }
    }
